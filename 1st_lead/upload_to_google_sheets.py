...
if __name__ == "__main__":
    ...
    # Load spreadsheet ID from environment variable (never hardcode)
    spreadsheet_id = os.getenv('GOOGLE_SHEETS_ID')
    if not spreadsheet_id:
        raise ValueError("GOOGLE_SHEETS_ID environment variable not set. Please configure your .env file.")
